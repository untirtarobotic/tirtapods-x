...
namespace legs {
  ...
  void ssc_forward_higher () {
    switch (state_nextStep) {
      case 0:
        com.println(F("#4P1724 #5P1713 #6P1774 #8P1286 #9P2731 #10P2269 #12P1375 #13P1574 #14P1750 #20P1472 #21P499 #22P798 #24P1258 #25P1329 #26P993 #28P1549 #29P121 #30P465 T220"));
        state_isComboBUp = true;
        state_nextStep = 1;
        break;
      case 1:
        com.println(F("#4P1724 #5P1713 #6P1774 #8P1286 #9P1775 #10P1783 #12P1375 #13P1574 #14P1750 #20P1472 #21P1222 #22P1220 #24P1258 #25P1329 #26P993 #28P1549 #29P1219 #30P1099 T220"));
        state_isComboBUp = false;
        state_nextStep = 2;
        break;
      case 2:
        com.println(F("#4P1480 #5P2432 #6P2106 #8P1514 #9P1775 #10P1783 #12P1176 #13P2551 #14P2365 #20P1251 #21P1233 #22P1117 #24P1542 #25P393 #26P561 #28P1328 #29P1207 #30P1216 T220"));
        state_isComboAUp = true;
        state_nextStep = 3;
        break;
      case 3:
        com.println(F("#4P1480 #5P1724 #6P1667 #8P1514 #9P1775 #10P1783 #12P1176 #13P1563 #14P1846 #20P1251 #21P1233 #22P1117 #24P1542 #25P1329 #26P993 #28P1328 #29P1207 #30P1216 T220"));
        state_isComboAUp = false;
        state_nextStep = 0;
        break;
    }
