...
bool detectLine() {
  ...
  if (line::isDetected && CounterRead == 2) {
    ...
    while ((currentFakeCounter - startFakeCounter) < 8700) {
      lcd::message(1, lcd::SHIFTING_RIGHT);
      currentFakeCounter = millis();
      legs::shiftRight();
    }
  ...
  if (line::isDetected && CounterRead == 4) {
    ...
    while ((currentFakeCounter - startFakeCounter) < 7600) {
      lcd::message(1, lcd::ROTATING_CCW);
      currentFakeCounter = millis();
      legs::rotateCCW();
    }
    while ((currentFakeCounter - startFakeCounter) < 8800) {
      lcd::message(1, lcd::SHIFTING_RIGHT);
      currentFakeCounter = millis();
      legs::shiftRight();
    }
  ...
  if (line::isDetected && CounterRead == 5) {
    ...
    while ((currentFakeCounter - startFakeCounter) < 3800) {
      lcd::message(1, lcd::MOVING_FORWARD);
      currentFakeCounter = millis();
      legs::forward();
    }
