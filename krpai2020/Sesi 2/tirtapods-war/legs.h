...
namespace legs {
  ...
  void ssc_forward_higher () {
    switch (state_nextStep) {
      case 0:
        com.println(F("#4P1724 #5P1845 #6P1888 #8P1286 #9P2731 #10P2269 #12P1375 #13P1695 #14P1845 #20P1472 #21P499 #22P798 #24P1258 #25P1196 #26P903 #28P1549 #29P121 #30P465 T400"));
        state_isComboBUp = true;
        state_nextStep = 1;
        break;
      case 1:
        com.println(F("#4P1724 #5P1845 #6P1888 #8P1286 #9P1911 #10P1884 #12P1375 #13P1695 #14P1845 #20P1472 #21P1098 #22P1119 #24P1258 #25P1196 #26P903 #28P1549 #29P1073 #30P973 T400"));
        state_isComboBUp = false;
        state_nextStep = 2;
        break;
      case 2:
        com.println(F("#4P1480 #5P2432 #6P2106 #8P1514 #9P1911 #10P1884 #12P1176 #13P2551 #14P2365 #20P1251 #21P1099 #22P1008 #24P1542 #25P393 #26P561 #28P1328 #29P1072 #30P1100 T400"));
        state_isComboAUp = true;
        state_nextStep = 3;
        break;
      case 3:
        com.println(F("#4P1480 #5P1845 #6P1772 #8P1514 #9P1911 #10P1884 #12P1176 #13P1695 #14P1949 #20P1251 #21P1099 #22P1008 #24P1542 #25P1196 #26P903 #28P1328 #29P1072 #30P1100 T400"));
        state_isComboAUp = false;
        state_nextStep = 0;
        break;
    }
